...
public class DownloadFattura extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            prodotti = productModel.doRetrieveByOrder(idOrdine);
        ...
        try {
            ...
            // Tabella Prodotti con 7 colonne
            PdfPTable table = new PdfPTable(7); // 7 colonne: Marca, Modello, Prezzo lordo, Quantità, IVA%, Prezzo netto, IVA importo
            ...
            for (ProductBean p : prodotti) {
                double aliquotaProdotto = p.getIva(); // Assumendo esista getIva() che ritorna la percentuale es: 22.0
                ...
                table.addCell("1"); // Modifica qui se hai getQuantita()
            ...
            final double aliquotaIVA = 22.0; // Aliquota IVA fissa (modifica se necessario)
