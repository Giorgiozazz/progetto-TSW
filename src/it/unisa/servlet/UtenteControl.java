    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("registrazione".equalsIgnoreCase(action)) {
            try {
                ...
                utente.setPassword(password); // Password in chiaro, verrà hashata nel DAO

                model.doSave(utente); // Il DAO si occupa dell'hashing
            ...
            try {
                ...
                // Non fare hashing qui! Lo fa già il DAO
            ...
            try {
                ...
                if (utente != null) {
                    ...
                    // PASSA IL TOKEN, NON IL LINK INTERO, modificato EmailUtils di conseguenza
            ...
            String nuovaPassword = request.getParameter("newPassword"); // correggo nome parametro

            String confermaPassword = request.getParameter("confirmPassword"); // controllo conferma password
            ...
            try {
                ...
                if (utente != null) {
                    ...
                    // Invalida il token se necessario (da implementare nel DAO)
