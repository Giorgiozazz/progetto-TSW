...
public class ProductModelDS implements ProductModel {
    ...
    public synchronized void doSave(ProductBean automobile) throws SQLException {
        ...
        String insertSQL = "INSERT INTO " + TABLE_NAME +
                ...
                "TIPO_CAMBIO, RAPPORTI, POTENZAELETTRICA, TRAZIONE, PESO, COLORE, POTENZA, IMAGEPATH, CF, VENDUTA, IVA) " +
                "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        try {
            ...
            preparedStatement.setDouble(26, automobile.getIva());
    ...
    public synchronized void updateProduct(ProductBean product) throws SQLException {
        ...
        String updateSQL = "UPDATE " + TABLE_NAME + " SET " +
                ...
                "POTENZA = ?, IMAGEPATH = ?, CF = ?, VENDUTA = ?, IVA = ? WHERE VIN = ?";
        ...
        try {
            ...
            preparedStatement.setDouble(25, product.getIva());
            preparedStatement.setString(26, product.getVin());
    ...
    public synchronized Collection<ProductBean> doSearchByKeyword(String keyword) throws SQLException {
        ...
        // Costruisco dinamicamente la query con AND fra i gruppi di OR (solo MARCA e MODELLO)
        ...
        try {
            ...
            while (rs.next()) {
                ...
                automobile.setTrazione(rs.getString("TRAZIONE"));
                automobile.setPeso(rs.getInt("PESO"));
                automobile.setColore(rs.getString("COLORE"));  // Puoi tenerlo perché è solo l'attributo, non influisce sulla ricerca
                automobile.setPotenza(rs.getInt("POTENZA"));
                automobile.setImmagine(rs.getString("IMAGEPATH"));
                automobile.setCf(rs.getString("CF"));
                automobile.setVenduta(rs.getBoolean("VENDUTA"));
    ...
    public synchronized List<ProductBean> getTop6Cars() throws SQLException {
        List<ProductBean> cars = new ArrayList<>();
        Connection connection = null;
        PreparedStatement preparedStatement = null;

        String sql = "SELECT MARCA, MODELLO, PREZZO FROM " + TABLE_NAME + " WHERE VENDUTA = FALSE LIMIT 6";
        ...
        try {
            ...
            while (rs.next()) {
                ProductBean car = new ProductBean();
                car.setMarca(rs.getString("MARCA"));
                car.setModello(rs.getString("MODELLO"));
                car.setPrezzo(rs.getDouble("PREZZO"));
                cars.add(car);
            }
            rs.close();
        } finally {
