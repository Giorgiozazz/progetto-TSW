...
<body>
   ...
   <div class="torna-wrapper">
	    <%
	        ...
	        if ("home".equals(from)) {
	    %>
	        <a class="ordina-link" href="<%= request.getContextPath() %>/home">TORNA ALLA HOME</a>
	    <%
	        } else {
	    %>
	        <a class="ordina-link" href="<%= request.getContextPath() %>/jsp/auto/catalogo.jsp">TORNA AL CATALOGO</a>
	    <%
	        } 
	    %>
	</div>
