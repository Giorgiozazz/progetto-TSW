  ...
  <div style="display: flex; justify-content: space-between; align-items: center;">
    ...
    <nav>
      <ul id="menu" class="menu-list">
        <li><a href="<%= request.getContextPath() %>/index.jsp" style="color: white;">Home</a></li>
        <li><a href="<%= request.getContextPath() %>/jsp/auto/catalogo.jsp" style="color: white;">Catalogo</a></li>
